...
text_top = ["<para alignment='center' fontName=TimesBold leading=20>Уведомление о необходимости прохождения иммунизации </para>", f"<para alignment='center' fontName=TimesBold>Уважаемый(-ая) ",
